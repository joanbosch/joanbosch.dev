    ...
    <>
      <section className='flex flex-row flex-wrap justify-center m-8 sm:m-32'>
        <article className='max-w-lg mt-2 mb-2 mr-4'>
          <h1 className='text-4xl sm:text-6xl sm:mt-8 mb-4 sm:mb-16 font-bold'>
            {locales.title}
          </h1>
          <p className='text-gray-600 text-xl'>{locales.subtitle}</p>
          <a
            className='mt-8 mb-8 flex flex-row items-center'
            href='mailto:joanboschpons@gmail.com?cc=joanboschpons@gmail.com&subject=Hi%2C%20I%20have%20an%20amazing%20oportunity%20for%20you'
          >
            <Image
              alt='mail logo'
              src='/mail.svg'
